...
class NERModel:
    ...
    def _ner_pipeline(self, text: str) -> List[dict]:
        """Run NER on a single sentence. Returns raw entities with 'type' and 'tokens'."""
        ...
        input_ids, predicted_tags = remove_special_tokens(
            inputs["input_ids"][0], predicted_tags, set(self.tokenizer.all_special_ids)
        )
