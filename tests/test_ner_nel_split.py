"""
Step 1 Local Test: Verify NER and NEL modules work independently.
Run from the classifier root: python test_step1.py
"""

import time

SAMPLE_TEXT = "Head Chef. We are looking for an experienced Head Chef who can plan menus, manage kitchen staff, and ensure food safety standards. A diploma in Culinary Arts is required."

print("=" * 60)
print("STEP 1 TEST: NER and NEL modules")
print("=" * 60)
...
for e in entities:
    print(f"        {e['entity_type']:15s}  \"{e['surface_form']}\"  (chars {e['span']['start']}-{e['span']['end']})")
...
print(f"  NER module: inference/ner.py  ✓")
print(f"  NEL module: inference/nel.py  ✓")
