...
const ENDPOINTS: Endpoint[] = [
  {
    ...
    path: "/v1/classify",
    description: [
      "Classify a single job description. Runs NER to detect occupations, skills, qualifications, experience, and domains; occupation, skill, and qualification spans are linked to ESCO via NEL.",
      "",
      "Request fields:",
      ...
      "  • options.extract_entities — filter types: \"occupation\", \"skill\", \"qualification\", \"experience\", \"domain\". Omit to extract all. (NEL linking applies only to occupation, skill, qualification.)",
