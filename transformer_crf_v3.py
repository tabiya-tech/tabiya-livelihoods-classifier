...
class RoBertaCrfForNer(BertPreTrainedModel):
    '''
    The use of the BertPreTrainedModel class as a parent class of roberta is done for successful implementation of the 'ner' infernce huggingface pipeline.
    This may cause some issues. TODO: Implement custom inference pipeline.
    '''
